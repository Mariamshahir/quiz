...
class _MoodyState extends State<Moody> {
  ...
  FlashyTabBar buildFlashyTabBar() {
    return FlashyTabBar(
        ...
        items: [
        FlashyTabBarItem(icon: Icon(Icons.home), title: Icon(Icons.home,color: Colors.green,size: 30),activeColor: Colors.green,inactiveColor: Colors.grey),
          FlashyTabBarItem(icon: Icon(Icons.apps), title: Icon(Icons.apps,color: Colors.green,size: 30,),activeColor: Colors.green,inactiveColor: Colors.grey),
          FlashyTabBarItem(icon: Icon(Icons.calendar_today_outlined), title: Icon(Icons.calendar_today_outlined,color: Colors.green,size: 30),activeColor: Colors.green,inactiveColor: Colors.grey),
          FlashyTabBarItem(icon: Icon(Icons.person_2_outlined), title: Icon(Icons.person_2_outlined,color: Colors.green,size: 30),activeColor: Colors.green,inactiveColor: Colors.grey),
                      ...
                      Column(
                        children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    SizedBox(width: 12,),
                                    Text("Meditation",style: TextStyle(fontSize: 15),)
                                  ],
                                ),
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                padding: EdgeInsets.symmetric(vertical: 20,horizontal: 30),                                  decoration: BoxDecoration(
  ...
  AppBar buildAppBar() {
    ...
    return AppBar(
      ...
      leading: Image.asset(AppAssets.moody, width: 50, height: 50,),
      title: Row(
        children: [
          Text("Moody"),
          Spacer(),
          badges.Badge(badgeContent:Text("${badgeCounter.toString()}"),
